  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        {/* Upper Grid: 3 Core Features (Dark Cards) - Animated sequentially */}
        {coreFeatures && coreFeatures.length > 0 && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 w-full mb-16">
            {coreFeatures.map((card, idx) => (
              ...
              >
                <div className="flex flex-col bg-[#18181B] text-white rounded-3xl p-8 border border-neutral-800 hover:border-neutral-700 transition-all duration-300 w-full">
                  {/* Icon Box */}
        ...
        {/* Lower Grid: 6 Highlight Features (Light Cards) - Animated sequentially */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full mt-8">
            {highlightFeatures.map((card, idx) => (
              <ScrollAnimatedContainer
                ...
                className="h-full flex"
              >
                <div className="flex flex-col bg-[#F3F4F6] dark:bg-neutral-900 border border-neutral-200/50 dark:border-neutral-800/80 rounded-2xl p-8 hover:shadow-md transition-all duration-300 w-full">
                  {/* Icon wrapper */}
