  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        {principlesList && principlesList.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 w-full max-w-7xl mx-auto mb-16">
            {principlesList.map((card, idx) => (
              ...
              >
                <div className="flex flex-col bg-[#F3F4F6] dark:bg-neutral-900 border border-neutral-200/40 dark:border-neutral-800/40 rounded-3xl p-8 items-start justify-start hover:shadow-md transition-all duration-300 w-full">
                  {/* Icon Box */}
        ...
        {/* Bottom CTA Action Buttons - Animates last */}
        <ScrollAnimatedContainer
          type="fade"
          duration={0.6}
          delay={0.35}
