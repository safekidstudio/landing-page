        ...
        <div className="bg-[#F3F4F6] dark:bg-neutral-900 rounded-3xl p-8 md:p-16 text-left flex flex-col items-start justify-center border border-neutral-200/40 dark:border-neutral-800/40">
          ...
          {isFilled.keyText(primary.button.text) && (
            <PrismicNextLink
              ...
              className="bg-[#18181B] hover:bg-neutral-800 dark:bg-white dark:hover:bg-neutral-100 text-white dark:text-neutral-900 rounded-full px-8 py-4 h-auto text-base font-semibold inline-flex items-center gap-2 transition-colors duration-200 mb-8"
            >
              <span>{primary.button.text || "Secure Your Early Access Spot"}</span>
