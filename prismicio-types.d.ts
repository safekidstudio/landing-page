 ...
 */
export type BlogPageDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<BlogPageDocumentData>, "blog_page", Lang>;
...
export type AllDocumentTypes = BlogPageDocument | HomePageDocument | PageDocument;
